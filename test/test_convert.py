...
#ngc1000 = {'icrs': {'x': '02:38:49.738', 'y': '+41:27:35.24',
#                'ep': 2000, 'eq': None},
#           'fk5': {'x': '02:38:49.738', 'y': '+41:27:35.24',
#                'ep': 2000, 'eq': 2000},
#           'fk4': {'x': '02:35:38.74', 'y': '+41:14:39.9',
#                'ep': 1950, 'eq': 1950},
#           'gal': {'x': 143.6647, 'y': -17.0483,
#                'ep': 2000, 'eq': None}
#           }
# KPNO from TPM code
#kpno = {'lat': 31.956389, 'lon': -111.598333, 'alt': 2093.093,
#        'T': 273.15, 'P': 1013.25, 'H': 0.0}
# Wavelength of observation in microns, default value in TPM
#wave = 0.55000
