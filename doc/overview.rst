...
TPM library is mainly used for performing coordinate conversions
...
This module, PyTPM, is a python interface to the TPM library,
generated using the SWIG_ application.
...
:func:`pytpm.utils.convert` function, which calls the function
:func:`pytpm.tpm.convert`, which itself is an interface to the
function *convert* in *src/convert.c*. Calling this function is
much easier that directly calling function :func:`pytpm.tpm.convert`,
since the former provides defaults for various arguments.
